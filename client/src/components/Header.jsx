      ...
      <div className="flex justify-between items-center max-w-6xl mx-auto p-4 m">
        <Link to="/">
          <h1 className="font-bold text-sm sm:text-xl flex flex-wrap">
            <span className="text-textMain">Estate</span>
            <span className="text-secondary">Hub</span>
          </h1>
        </Link>
        <form onSubmit={handleSubmit} className="bg-textMain p-3 rounded-lg flex items-center">
          <input
            type="text"
            placeholder="Search..."
        ...
        <ul className="flex gap-7">
          <Link to="/">
            <li className="hidden sm:inline text-textMain hover:underline">
              Home
            </li>
          </Link>
          <Link to="/about">
          ...
          <Link to="/profile">
            {currentUser ? (
              ...
              <li className="text-textMain hover:underline">Sign in</li>
            )}
          </Link>
        </ul>
      </div>
